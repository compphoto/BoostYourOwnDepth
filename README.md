...
We also provide code to calculate the corresponding R20 resolution for your image, if you want to create your high-resolution input similar to our paper.
